...
export const Notification = () => {
  return(
    <div className={s.unleash_notification}>
      <div className={s.unleash_notification__info}>
        <div className={s.unleash_notification__info_logo}>
          ...
          <div className={s.unleash_notification__avatar}>
            <img src="./img/notofication-avatar.jpg" alt="avatar" className={s.unleash_notification__avatar_img}/>
            <img src='./img/verified.svg' alt="verified" className={s.unleash_notification__avatar_verified}/>
          </div>
        </div>
      ...
      <img src="./img/notofication-logo.jpg" alt="notofication-logo" className={s.unleash_notification__logo}/>
    </div>
  )
}
